...
import static hence.com.pumpkinnote.R.id.rlDateTimeRecurrenceInfo;
import static hence.com.pumpkinnote.R.id.svMainContainer;
import static hence.com.pumpkinnote.R.id.tvActivatedPickers;
import static hence.com.pumpkinnote.R.id.tvPickerToShow;
        ...
        ivLaunchPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!optionsPair.first) { // If options are not valid
                    Toast.makeText(SetAlarmActivity.this, "No pickers activated",
